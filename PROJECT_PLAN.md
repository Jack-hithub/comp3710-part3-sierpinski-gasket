...
## Stage 1 - mathematical construction

- [x] Identify the Pascal-triangle parity condition.
- [x] Check small rows by hand.
- [x] Verify the count `3^n` in the first `2^n` rows.
...
- [x] Compare the PyTorch mask with known small Pascal rows.
...
- [x] Save figures and box-count CSV measurements.
